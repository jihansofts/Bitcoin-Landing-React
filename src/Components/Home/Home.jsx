        ...
        <div className="grid grid-cols-12 gap-8 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 text-center lg:text-left">
            <div className="w-full max-w-lg mx-auto lg:max-w-none">
              <h1 className="text-[32px] sm:text-[42px] md:text-[50px] lg:text-[60px] xl:text-[72px] font-Inter text-white font-bold leading-tight">
                Unlock the Power of <br className="hidden lg:block" />
                <span className="text-buttonColor">Bitcoin</span> – Learn,
                Invest, Succeed!
              </h1>
              <p className="text-[16px] max-md:text-[14px] text-white mt-5 leading-relaxed">
